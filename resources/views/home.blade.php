...
<body class="antialiased">
   <!--Jumpbostron-->
      <div class="mt-4 p-5 text-white rounded" style="background-color: rgb(11, 189, 189);">
        ...
        <p>
          <h5>
            The Beautiful Church of Christ, would like to welcome everyone who would like to know more our church and her ministries. We are ready to give you detail information and the knowledge of God through our website. Our church will give you all more resources such as weekly sermon; Shorter and Larger Catechism; other programs our church is developing. 
            Everyone can come and visit our church in the website or the real church we here wait and serve all of you. 
          </h5>
        </p> 
        <a href="/create-post" class="btn btn-info btn-warning" style="font-family: khmer OS System;">Create Post</a>
      </div>
        <h3 class="mt-5">All Activities</h3>
  ...
  <a href="/listing"><button class="btn btn-danger">See all</button></a>
</body>
@endsection
