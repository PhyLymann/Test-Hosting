...
.link a:hover{
  ...
  <div class="marquee">
    <marquee class="m-3" behavior="" direction="left">
      <i class="fa-solid fa-cross"></i>&nbsp;យើងជឿថា ព្រះយេស៊ូវគ្រីស្ទ ជាព្រះអាទិករបង្កើតផ្ទៃមេឃ និងផែនដី។ ព្រះយេស៊ូវគឺជាផ្លូវ សេចក្តីពិត និងជីវិត ដែលជួយសង្រ្គោះយើងឱ្យរួចផុតពីអំពើបាប នាំទៅរកជីវិតដ៏នៅអស់កល្បជានិច្ច។
